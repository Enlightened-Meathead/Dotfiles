...
M.general = {
  ...
  n = {
    ...
    -- Search for wiki links contained in double square brackets, URL links in markdown, and image links in markdown
    ["<leader>ws"] = { ':/\\[\\[[^\\]]*\\]\\]\\|\\v\\[([^\\]]*)\\]\\([^\\)]+\\)|\\v!\\[([^\\]]*)\\]\\([^\\)]+\\)<CR>', "Search for wiki links within the current file"},
    ...
    ["<leader>sn"] = {":set nospell<CR>", "Set no spell checking"},
